...
return [
    ...
    */
    ...
    'meta' => [
         Meta::name('author', 'AlixcaN'),
         Meta::name('twitter:creator', '@AlixcaNN'),
         Meta::name('description', 'Bir Başka Developer Bloğu'),
         Meta::name('keywords', 'Laravel, Blog, Php, Css, Development, Architecture, Sql, Tailwind, Alpine, Vue, Js'),
    ...
    */
    ...
    'authors' => [
        Author::create(
            'alixcan', // Required username
            'AlixcaN', // Optional display name
            'https://alixcan.net' // Optional website URL
        ),
    ],
